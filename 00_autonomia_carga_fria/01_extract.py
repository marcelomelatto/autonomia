...
DIM_LOCAL_SAP_PATH = os.path.join(BASE_CDSW, "DIM_LOCAL_SAP.xlsx")
DIM_MATERIAL_PATH = os.path.join(BASE_DIR, "DIM_MATERIAL.xlsx")
DIM_RESPONSAVEL_PATH = os.path.join(BASE_DIR, "DIM_RESPONSAVEL.xlsx")
DIM_SAZONALIDADE_PATH = os.path.join(BASE_DIR, "sazonalidade_decomposta.xlsx")
